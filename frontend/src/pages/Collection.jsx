        ...
        >
          ...
          <div className="flex flex-col gap-2 text-sm font-light text-gray-700">
            <p className="flex gap-2">
              <input type="checkbox" name="" id="" value={"Men"} onChange={toggleCategory} className="w-3" />Men
            </p>
            <p className="flex gap-2">
              <input type="checkbox" name="" id="" value={"Women"} onChange={toggleCategory} className="w-3" />Women
            </p>
            <p className="flex gap-2">
              <input type="checkbox" name="" id="" value={"Kids"} onChange={toggleCategory} className="w-3" />Kids
            </p>
          </div>
        </div>
